...
\vspace{1.5in}
\includegraphics[width=3.5in]{figs/ncbi-logo}
...
\begin{slide}
\begin{center}
\large{\textbf{Central dogma of molecular biology}}
\end{center}
\medskip
\center{\includegraphics[width=5in]{figs/central-dogma}}
\vfill
\end{slide}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{slide}
...
\begin{slide}
\begin{center}
{\bf How do we find structural RNA homologs?}
\medskip
...
%             & profiles& profiles \\ \hline
  ...
  databases  & {\sc Pfam} and \sc{Dfam}       & {\sc Rfam} \\
             & (17929 and 6915 entries) & (3016 families) \\
  \\
...
\input{prob-hmm-cm-slides-inserts.tex}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\center{\includegraphics[height=4in]{figs/gp1-schematic-big.png}}\footnote{\small{A. Hedberg and S. D. Johansen, Mobile DNA, 2013 4:17}}
...
\center{\includegraphics[width=10in]{figs/gp1-fig2-ss}}\footnote{
...
\begin{slide}
\begin{center}
\textbf{Sequence analysis is powerful and important}
\end{center}
\medskip
...
\item Annotation is aided by (\emph{and adds to}) existing knowledge of homologous proteins in related flaviviruses
\item Knowledge of genes and other features is crucial towards
  understanding an organism (informs experiments, aids development of vaccines)
%\item Genome annotation and sequence analysis, in general, is \emph{data science}.
\end{itemize}

%\center{\includegraphics[width=3.5in]{figs/data-science-def}}
...
\begin{itemize}
%\item Single polyprotein that is cleaved into 14 mature peptides
%\item Annotation enabled by existing knowledge of homologous proteins
%  in related flaviviruses
...
%\end{center}
\center{\includegraphics[width=10.5in]{figs/bacteria-info-mutinfo}}
\end{slide}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{slide}
%\begin{center}
%\textbf{Conservation levels and insertion frequency vary in SSU rRNA}
%\end{center}
\center{\includegraphics[width=10.5in]{figs/bacteria-info-inserts}}
\end{slide}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{slide}
